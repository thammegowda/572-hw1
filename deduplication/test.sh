...
python main.py -i $img_dir -d $exact_out_dir -s -o $exact_out_json
echo "================================"

echo "NEAR DEDUPLICATION TEST"
echo "================================"
echo "Running near deduplication algorithm on images in folder test_images"
python main.py -i $img_dir -n -d $near_out_dir -s -o $near_out_json 
echo "================================"
...
#echo "================================"
#echo "JSONLINES NEAR DEDUPLICATION TEST"

#echo ""
#echo "---------"
#echo "Running the metadata dumper program"
#echo "---------"
#echo ""

#rm $near_in_json_metadata 
#java -jar ../metadata-dumper/target/metadata-dumper-0.1-SNAPSHOT-jar-with-dependencies.jar -inputDir $img_dir -output $near_in_json_metadata

#echo ""
#echo "---------"
#echo "Running near deduplication algorithm on images in folder test_images, with pull"
#echo "---------"
#echo ""

#python main.py -n -l $near_in_json_metadata 
#echo "================================"
